...
API_ID = int(environ.get('API_ID', '24071415'))
API_HASH = environ.get('API_HASH', '4b584c0d66245e9a467d5e7aa0535cfd')
BOT_TOKEN = environ.get('BOT_TOKEN', "8287026891:AAGW0BiRGuvD20S3KHpYd3xJd8d6no_dINk")
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '8107411538').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '1003158309838'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '1003294507964').split()]  # For Multiple Id Use One Space Between Each.
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '1003294507964')).split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://sadeshahansana2_db_user:xNj02dZIjCebf31f@cluster0.rjmdvlo.mongodb.net/")   # IF Multiple Database Is False Then Fill Only This Database Url.
